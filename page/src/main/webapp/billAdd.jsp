        ...
        $.ajax({
           url:"${pageContext.request.contextPath}/bill/getPro.do",
            ...
            success: function (data) {
               var str = "<option value=''>--请选择相应的公司--</option>";
    ...
    function checkProId() {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data == "exits") {
                    $("#billId+span").html("税收编码已存在,请重新输入");
                    return false;
                }
                if (data == "error") {
                    $("#billId+span").html("请输入税收编码");
                    return false;
                }
            }
        });
