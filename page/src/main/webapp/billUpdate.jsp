...
<script>
    ...
    function checkBillName() {
        ...
        if(name.length==""){
            $("#providerName+span").html("*请填写税收类别");
            return false;
        }
    ...
    function checkProId() {
        ...
        $.ajax({
            ...
            success:function (data) {
                ...
                if(data=="exits"){
                    $("#providerId+span").html("税收编码已存在,请重新输入");
                    return false;
                }
                if(data=="error"){
                    $("#providerId+span").html("请输入税收编码");
                    return false;
                }
            }
        });
