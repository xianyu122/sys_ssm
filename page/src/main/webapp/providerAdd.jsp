...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body">
        ...
        <div class="location">
            ...
            <span>公司管理页面 >> 公司添加页面</span>
        </div>
        <div class="providerAdd">
            <form action="#" method="post" id="addProForm">
                <!--div的class 为error是验证错误，ok是验证成功-->
                <div class="">
                    <label for="providerId">公司编码：</label>
...
//测试注释
    ...
    function checkProName() {
        ...
        if(providerName==""){
            $("#providerName+span").html("请填写公司名称");
            return false;
        }
        $.ajax({
            ...
            success:function (data) {
                ...
                if(data=="exits"){
                    $("#providerName+span").html("公司已存在,请重新输入");
                    return false;
                }
                if(data=="error"){
                    $("#providerName+span").html("请输入公司");
                    return false;
                }
            }
        });
    ...
    function checkProCodeExits() {
        ...
        $.ajax({
            ...
            success:function (data) {
                ...
                if(data=="exits"){
                    $("#providerId+span").html("公司编码已存在,请重新输入");
                    return false;
                }
                if(data=="error"){
                    $("#providerId+span").html("请输入公司编码");
